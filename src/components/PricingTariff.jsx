                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                                ...
                                <h5 className="font-bold text-gray-900 mb-3">Simultano i konsekutivno prevođenje</h5>
                                <div className="flex justify-between items-center py-2 border-t border-dotted border-gray-200">
                                    <span className="text-sm text-gray-600">Puni sat prevođenja</span>
                                    <span className="font-bold text-[#1e40af]">50,00 KM</span>
                                </div>
                                <div className="flex justify-between items-center py-2 border-t border-dotted border-gray-200">
                                    <span className="text-sm text-gray-600">Započeti sat</span>
